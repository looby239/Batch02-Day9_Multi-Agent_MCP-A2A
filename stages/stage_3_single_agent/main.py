...
QUESTION = (
    "Một công ty khởi nghiệp công nghệ có doanh thu 5 triệu USD bị phát hiện chia sẻ "
    "dữ liệu người dùng mà không có sự đồng ý và trốn nộp thuế đối với doanh thu "
    "từ nước ngoài. Toàn bộ các hậu quả pháp lý là gì?"
)
